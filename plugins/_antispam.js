...
userData.message++  
motive = 'SPAM LEVE'
mensaje = `@${m.sender.split`@`[0]} Anda tidak dapat menggunakan bot selama *2 Menit*\n\n*Alasan:* ${motive}`  
...
mensaje = `@${m.sender.split`@`[0]} Anda tidak dapat menggunakan bot selama *5 Menit*\n\n*Alasan:* ${motive}`
await conn.reply(m.chat, mensaje, m, { mentions: [m.sender] })  
user.messageSpam = motive
...
motive = 'SPAM GRAVE'
mensaje = `@${m.sender.split`@`[0]} Anda tidak dapat menggunakan bot selama *10 Menit*\n\n*Alasan:* ${motive}`
await conn.reply(m.chat, mensaje, m, { mentions: [m.sender] }) 
user.messageSpam = motive
}}
